...
<body>
	<div class="bodywrap">
		<div class="imgslide">
			<a href="#">
				<img alt="" src="layout_image/1.png">
			</a>
			<a href="#">
				<img alt="" src="layout_image/2.png">
			</a>
			<a href="#">
				<img alt="" src="layout_image/3.png">
			</a>
		</div>
					...
					<section id="upcoming">
						...
						<div class="pickimg_item" style="padding: 20px;">
							<ul class="top5_list">
								...
								<li><a href="index.jsp?main=review/review_moviedetail.jsp?movie_genre=all&sort=recent&movie_num=<%=dto.getMovie_num()%>&currentPage=1">
										<img src="movie_save/<%=dto.getMovie_poster()%>">
									</a>
									<h3 class="img_text"><%=Math.round(dto.getMovie_rank_avg()*10.0)/10.0%>
										|
										<%=dto.getMovie_subject()%></h3></li>
								<%
								}
								%>
							</ul>
								...
								<section id="upcoming2">
									<ul>
										...
										<li><a href="index.jsp?main=review/review_moviedetail.jsp?movie_genre=all&sort=recent&movie_num=<%=dto.getMovie_num()%>&currentPage=1">
											...
											<h3 class="img_text"><%=dto.getMovie_pcount()%>
												|
												<%=dto.getMovie_subject()%></h3></li>
										<%
										}

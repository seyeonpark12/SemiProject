 ...
 * Generated at: 2023-03-24 07:06:26 UTC
...
public final class review_005fmoviedetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("		});\r\n");
      out.write("		//리뷰생성\r\n");
      out.write("		var reviewform = document.getElementById('myform');\r\n");
      out.write("\r\n");
      out.write("		reviewform.addEventListener('submit', function(event) {\r\n");
      ...
      out.write("\r\n");
      out.write("		});\r\n");
      out.write("		$(document).on(\"click\", \"#review_del\", function() {\r\n");
      out.write("\r\n");
...
no = totalCount - (currentPage_review - 1) * perPage;
      ...
      out.write("						<div style=\"text-align: center; font-size: 20pt; padding: 5px; margin-left: 13px;\">\r\n");
      out.write("							<b style=\"font-size: 15pt; color: #fff\">");
      ...
      out.print(myid);
      out.write("\">\r\n");
      out.write("							<input type=\"hidden\" id=\"user_num\" value=\"");
      out.print(user_num);
      out.write("\">\r\n");
      out.write("							<input type=\"hidden\" id=\"user_nickname\" value=\"");
      out.print(user_nickname);
      out.write("\">\r\n");
      out.write("							<fieldset>\r\n");
      out.write("								<input type=\"radio\" name=\"review_Star\" value=\"5\" id=\"rate1\">\r\n");
      out.write("								<label for=\"rate1\">★</label>\r\n");
      out.write("								<input type=\"radio\" name=\"review_Star\" value=\"4\" id=\"rate2\">\r\n");
      out.write("								<label for=\"rate2\">★</label>\r\n");
      out.write("								<input type=\"radio\" name=\"review_Star\" value=\"3\" id=\"rate3\">\r\n");
      out.write("								<label for=\"rate3\">★</label>\r\n");
      out.write("								<input type=\"radio\" name=\"review_Star\" value=\"2\" id=\"rate4\">\r\n");
      out.write("								<label for=\"rate4\">★</label>\r\n");
      out.write("								<input type=\"radio\" name=\"review_Star\" value=\"1\" id=\"rate5\">\r\n");
      out.write("								<label for=\"rate5\">★</label>\r\n");
      out.write("							</fieldset>\r\n");
      out.write("							<div style=\"float: left; padding: 10px;\">\r\n");
      out.write("								<textarea class=\"col-auto form-control\" id=\"review_contents\" style=\"width: 350px; height: 180px; padding: 20px; border: none; outline: none; resize: none;\" placeholder=\"욕설과 비방을 작성 시 제재를 당할 수 있습니다.\" required=\"required\">");
      out.print(compare > 0 ? "[기대평]" : "");
      out.write("</textarea>\r\n");
      out.write("							</div>\r\n");
      out.write("							<div style=\"margin: 0 40%;\">\r\n");
      out.write("								<button type=\"submit\" class=\"btn btn-default\" id=\"review_save\">저장하기</button>\r\n");
      out.write("							</div>\r\n");
      out.write("						</form>\r\n");
      out.write("					</div>\r\n");
      out.write("				</div>\r\n");
      ...
      out.write("					<!-- 영화이미지 보이는 이미지 -->\r\n");
      out.write("					<a style=\"display: inline-block; width: 100%; height: 400px; margin: 2px; padding: 10px; overflow: hidden;\">\r\n");
      out.write("						<img src=\"movie_save/");
      out.print(poster);
      out.write("\" movie_num=\"");
      out.print(movie_num);
      out.write("\" id=\"movie_poster\" class=\"posterimg\">\r\n");
      out.write("					</a>\r\n");
      out.write("				</td>\r\n");
      out.write("				<td colspan=\"4\" width=\"70%\" height=\"70%\" style=\"padding: 200px 0 0 30px;\">\r\n");
      out.write("					<b class=\"mv_subject\">");
      out.print(mdto.getMovie_subject());
      out.write("</b>\r\n");
      out.write("				</td>\r\n");
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<td colspan=\"4\" style=\"padding: 0 30px;\">\r\n");
      out.write("					<b class=\"mv_content_year\" style=\"color: gray; font-weight: 400;\">");
      ...
      out.write("			</tr>\r\n");
      out.write("			<tr>\r\n");
      out.write("				<td colspan=\"4\" style=\"padding: 30px; width: 100%\">\r\n");
      out.write("					<b class=\"mv_content_year\" style=\"color: orange; font-size: 20px;\">\r\n");
      out.write("						★\r\n");
      out.write("						");
      out.print(review_avgscore);
      out.write("</b>&nbsp;&nbsp;&nbsp;\r\n");
      out.write("					<b style='color: red; font-size: 20px; margin-right: 2px;'>♥</b>\r\n");
      ...
      out.write("			<button type=\"button\" class=\"btn btn-default btn-sm\" style=\"margin-left: 1050px; border: 1px solid #CBB6D9; color: #CBB6D9; float: left;\" onclick=\"location.href='index.jsp?main=movie/movie_updateform.jsp?movie_num=");
      out.print(movie_num);
      out.write("'\">영화수정</button>\r\n");
      out.write("			<button type=\"button\" class=\"btn btn-default btn-sm\" style=\"border: 1px solid #a02982; color: #a02982; float: left; margin-left: 5px;\" id=\"movie_delete\" movie_num=\"");
      out.print(movie_num);
      ...
      out.write("\r\n");
      out.write("		<div style=\"float: right; margin-top: -195px; margin-right: 300px;\">\r\n");
      out.write("			<b id=\"movie_pickadd\" movie_num=\"");
      out.print(movie_num);
      out.write("\" class=\"mv_content_es\" style=\"margin-left: -100px; cursor: pointer; font-size: 16px; font-weight: 400;\">\r\n");
      out.write("				PICK\r\n");
      out.write("				<font style=\"margin-left: 5px; color: red; font-size: 18px;\">♡</font>\r\n");
      out.write("			</b>\r\n");
      out.write("			<b data-toggle=\"modal\" data-target=\"#modal\" class=\"mv_content_es\" style=\"font-size: 16px; margin-left: 5px; font-weight: 400;\" id=\"review_add\">\r\n");
      out.write("				|&nbsp;&nbsp;");
      out.print(compare > 0 ? "기대평 남기기" : "리뷰하기");
      out.write("<span style=\"margin-left: 5px;\" class=\"glyphicon glyphicon-pencil\"></span>\r\n");
      out.write("			</b>\r\n");
      out.write("		</div>\r\n");
      out.write("		");
      ...
      out.write("			<!-- 목록가기 버튼.. -->\r\n");
      out.write("			<button type=\"button\" class=\"btn btn-default btn-sm\" style=\"margin-right: 300px; border: 1px solid #CBB6D9; color: #fff; background-color: #CBB6D9; float: right;\" onclick=\"location.href='index.jsp?main=movie/movie_list.jsp?movie_genre=all&sort=recent&currentPage=1'\">목록</button>\r\n");
      out.write("		</div>\r\n");
      out.write("		<br>\r\n");
      out.write("		<hr>\r\n");
      out.write("		<div style=\"width: 1000px; padding: 20px; border: 1px solid lightgray; border-radius: 30px;\">\r\n");
      out.write("			<h3 style=\"padding: 10px 30px 0px 30px; font-size: 18px; font-weight: 700;\">기본정보</h3>\r\n");
      out.write("			<div style=\"width: 100%; margin-bottom: 20px; padding: 30px; font-size: 16px; font-weight: 400; color: gray;\" id=\"movie_content\">");
      out.print(mdto.getMovie_content());
      out.write("</div>\r\n");
      out.write("			<hr>\r\n");
      out.write("			<h3 style=\"padding: 10px 30px 0px 30px; font-size: 18px; font-weight: 700;\">출연/제작</h3>\r\n");
      out.write("			<div>\r\n");
      out.write("				<div style=\"width: 100%; padding: 30px 30px 0px 30px; font-size: 16px; font-weight: 400; color: gray;\" id=\"movie_content\">\r\n");
      out.write("					감독 |\r\n");
      out.write("					");
      out.print(mdto.getMovie_director());
      out.write("</div>\r\n");
      out.write("				<div style=\"width: 100%; padding: 15px 30px 30px 30px; font-size: 16px; font-weight: 400; color: gray;\" id=\"movie_content\">\r\n");
      out.write("					배우 |\r\n");
      out.write("					");
      ...
      out.write("			</div>\r\n");
      out.write("			<hr>\r\n");
      out.write("			<h3 style=\"padding: 30px; font-size: 18px; font-weight: 700;\">");
      out.print(compare > 0 ? "기대평" : "리뷰");
      out.write("<span style=\"color: #CBB6D9; font-size: 13pt;\">\r\n");
      out.write("					[");
      ...
      out.write("					<tr>\r\n");
      out.write("						<th width=\"8%\" class=\"myinfo\" style=\"text-align: center;\">번호</th>\r\n");
      out.write("						<th width=\"60%\" class=\"myinfo\" style=\"text-align: center;\">내용</th>\r\n");
      out.write("						<th width=\"8%\" class=\"myinfo\" style=\"text-align: center;\">작성자</th>\r\n");
      out.write("						<th width=\"8%\" class=\"myinfo\" style=\"text-align: center;\">점수</th>\r\n");
      out.write("						<th width=\"8%\" class=\"myinfo\" style=\"text-align: center;\">작성일</th>\r\n");
      out.write("						<th width=\"8%\" class=\"myinfo\" style=\"text-align: center;\"></th>\r\n");
      out.write("					</tr>\r\n");
      out.write("					");
      ...
      out.write("\r\n");
      out.write("						<td>\r\n");
      out.write("							<button type=\"button\" class=\"btn btn-default btn-sm\" review_num=\"");
      out.print(dto.getReview_num());
      out.write("\" id=\"review_del\" style=\"margin-left: 10px;\">삭제</button>\r\n");
      out.write("						</td>\r\n");
      out.write("						");
      ...
      out.write("\r\n");
      out.write("					<li><a href=\"index.jsp?main=review/review_moviedetail.jsp?movie_genre=");
      ...
      out.write("\r\n");
      out.write("					<li class=\"active\"><a href=\"index.jsp?main=review/review_moviedetail.jsp?movie_genre=");
      out.print(movie_genre);
      out.write("&movie_num=");
      out.print(movie_num);
      out.write("&currentPage=");

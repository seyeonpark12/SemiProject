	...
	<div class="myinfo_div">
		<table style="width: 700px;">
			<caption>
				...
				<div style="width: 100%; float: left;">
					...
					<div style="margin-top: 30px;">
						...
						<a class="editbtn" style="float: left; margin-left: 480px;" href='index.jsp?main=mypage/mypage_myinfoupdate.jsp?user_num=<%=user_num%>'>EDIT</a> <a class="editbtn" id="userdelete" style="float: left; margin-left: 5px; border: 1px solid red; color: red;" user_num=<%=user_num%>>DELETE</a>
					</div>
				</div>
			</caption>
			<%
			...
			<tr>
				...
				<td class="myinfo" width="500">
					&nbsp;&nbsp;&nbsp;<%=dto.getUser_name()%></td>
			</tr>
			<tr>
				<th class="myinfo">닉네임</th>
				<td class="myinfo">
					&nbsp;&nbsp;&nbsp;<%=dto.getUser_nickname()%></td>
			</tr>
		...
		<!-- 영화!!!!!! 내가 쓴 리뷰!!!!!!!!!!  -->
		<a class="morebtn" href='index.jsp?main=mypage/login_mypage_myreview.jsp?user_num=<%=user_num%>'>+MORE</a>
		...
		<table style="width: 1000px;">
			...
			%>
			<h3>
				내가 쓴 리뷰 <b style="color: purple; font-size: 17pt"><%=myReViewCount%></b>
			</h3>
			<tr class="tr_myinfo">
		...
		<!-- 커뮤니티!!!!! 내가 쓴 글!!!! -->
		<a class="morebtn" href='index.jsp?main=mypage/login_mypage_mywrite.jsp?user_num=<%=user_num%>'>+MORE</a>
		<table style="width: 1000px;">
			<input type="hidden" name="user_num" value="<%=user_num%>">
			...
			%>
			<h3>
				내가 쓴 글 <b style="color: purple; font-size: 17pt"><%=myCommuCount%></b>
			</h3>
			<tr class="tr_myinfo">
		...
		<!-- 커뮤니티!!!!!! 내가 쓴 댓글!!!!!!!!!!!!! -->
		<a class="morebtn" href='index.jsp?main=mypage/login_mypage_mycomment.jsp?user_num=<%=user_num%>'>+MORE</a>
		...
		<table style="width: 1000px;">
			...
			%>
			<h3>
				내가 쓴 댓글 <b style="color: purple; font-size: 17pt"><%=myMentCount%></b>
			</h3>
			<tr class="tr_myinfo">
				<th width="200" class="myinfo">카테고리</th>

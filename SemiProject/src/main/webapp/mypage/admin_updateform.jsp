...
<body>
	<div>
		...
		<div class="myinfo_div">
			<form action="mypage/admin_myinfoupdateaction.jsp" method="post" onsubmit="return passcheck(this)">
						...
						<td colspan="2" style="text-align: center;">
							<div class="form-group">
								...
								<div style="float: right;">
									<button type="submit" class="btn btn-default btn-sm" style="margin-left: -600px; margin-bottom: 10px;">관리자정보수정</button>

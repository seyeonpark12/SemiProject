...
<body>
	<div class="myinfo_div">
		...
		<h3 style="margin-left: 450px; margin-bottom: 50px;">
			MYPICK
			<b style="color:purple; font-size:17pt"><%=myPickCount%></b></h3>
			...
			<div class="pick" style="position: relative; height: 500px;">
				<ul>
					<li><a
						...
						<h3
							style="padding: 20px; font-size: 18px; margin-left:30px; margin-top: -55px; font-weight:600;"><%=movie_subject %></h3>
					</li>
				</ul>

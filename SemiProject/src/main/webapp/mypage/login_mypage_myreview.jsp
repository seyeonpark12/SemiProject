	...
	$(function(){
		...
		$("#myreviewdelete").click(function(){
			...
			if(len==0){
				...
				var review_n="";
				var user_num=$(".checkdelete").attr("user_num");
				...
				review_n=review_n.substring(0, review_n.length-1);
				
				if(a==1){
					
					location.href="mypage/mypage_myreview_delete.jsp?nums="+review_n+"&user_num="+user_num;
...
<body>
	...
	<div style="width: 500px; text-align: center;" class="container">
      ...
      if(startPage>1){
         %>
			<li><a
				href="index.jsp?main=mypage/login_mypage_myreview.jsp?currentPage=<%=startPage-1 %>">이전</a>
			</li>
			<%}
      ...
      for(int pp=startPage;pp<=endPage;pp++){
         ...
         if(pp==currentPage){
            %>
			<li class="active"><a
				href="index.jsp?main=mypage/login_mypage_myreview.jsp?currentPage=<%=pp %>"><%=pp %></a>
			</li>
			<% } else{
            %>
			<li><a
      ...
      if(endPage<totalPage){
         %>
			<li><a
				href="index.jsp?main=mypage/login_mypage_myreview.jsp?currentPage=<%=endPage+1 %>">다음</a>
			</li>
			<%}
      %>
		</ul>

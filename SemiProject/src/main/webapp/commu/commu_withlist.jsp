...
<<<<<<< HEAD
				style="font-size: 18px; font-weight: bold; color: black; padding-right: 10px;">동행 |</a>
=======
...
<<<<<<< HEAD
   ...
   <ul class="pagination">
      ...
      if(startPage>1){
         %>
         <li>
            <a href="index.jsp?main=commu/commu_withlist.jsp?currentPage=<%=startPage-1 %>">이전</a>
         </li>
      <%}
      ...
      if(endPage<totalPage){
         %>
         <li>
            <a href="index.jsp?main=commu/commu_withlist.jsp?currentPage=<%=endPage+1 %>">다음</a>
         </li>
      <%}
      %>
   </ul>

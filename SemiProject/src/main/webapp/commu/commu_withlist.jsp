...
<body>
	...
	<div class="category"
		style="width: 1000px; margin-top: 100px; margin-left: 660px;">
		...
		<div style="float: left;">
			<a href="index.jsp?main=commu/commu_withlist.jsp"
				style="font-size: 18px; font-weight: bold; color: black; padding-right: 10px;">동행
				|</a>
		</div>
		<div style="float: left;">
 ...
 %> <img
		...
		if(loginok!=null){
			...
			<button type="button"
				id="admindelete" class="btn btn-default btn-sm"
				onclick="location.href='#'">삭제</button>
			<%}%>

			
				<button type="button" class="btn btn-default btn-sm" style="float:right; margin-right:270px;"
	...
	<div style="width: 500px; text-align: center;" class="container">
		<ul class="pagination">
			...
			%>
			<li><a
				href="index.jsp?main=commu/commu_withlist.jsp?currentPage=<%=startPage - 1%>">이전</a>
			</li>
			<%
			}
			...
			%>
			<li class="active"><a
				href="index.jsp?main=commu/commu_wuthlist.jsp?currentPage=<%=pp%>"><%=pp%></a>
			</li>
			<%
			} else {
			%>
			<li><a
				href="index.jsp?main=commu/commu_withlist.jsp?currentPage=<%=pp%>"><%=pp%></a>
			</li>
			<%
			}
			...
			%>
			<li><a
				href="index.jsp?main=commu/commu_withlist.jsp?currentPage=<%=endPage + 1%>">다음</a>
			</li>
			<%
			}
			%>

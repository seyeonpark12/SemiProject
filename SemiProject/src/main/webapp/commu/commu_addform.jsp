         ...
         <caption><b class="mv_content">게시판 글쓰기</b></caption>
            <tr>
               ...
               <select style="width: 200px;" name="commu_category" class="form-control" required="required">
                  <option value="자유" <%=commu_category.equals("자유")?"selected='selected'":""%>>자유</option>
                  <option value="동행" <%=commu_category.equals("동행")?"selected='selected'":""%>>동행</option>
                  <option value="나눔" <%=commu_category.equals("나눔")?"selected='selected'":""%>>나눔</option>
               </select>
               </td>

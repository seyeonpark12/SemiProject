...
<body>
	...
	<div class="category" style="width: 1000px; margin-top: 100px; margin-left: 670px;">
		...
		<div style="float: left;">
			<a href="index.jsp?main=commu/commu_freelist.jsp?category=free" style="font-size: 18px; font-weight: bold; color: #653491; padding-right: 10px;">자유 </a>
		</div>
		<div style="float: left;">
	...
	<div class="myinfo_div">
		...
		<table style="width: 1000px;">
			...
			<tr class="tr_myinfo">
				...
				<td class="myinfo">
					<a style="float: left; margin-left: 50px; padding: 0px 5px;" href="index.jsp?main=commu/commu_detail.jsp?category=free&commu_num=<%=dto.getCommu_num()%>&currentPage=<%=currentPage%>"> <%=dto.getCommu_subject()%></a>
					<%
					//이미지 첨부된 경우 아이콘 표시
					...
					%>
					<a href="index.jsp?main=commu/commu_detail.jsp?category=free&commu_num=<%=dto.getCommu_num()%>&currentPage=<%=currentPage%>" style="float: left; color: red;">[<%=dto.getAnswerCount()%>]
					</a>
					<%
					}
		...
		<div style="float: right;">
			...
			<button type="button" class="btn btn-default btn-sm" style="float: right; margin-left: 5px;" onclick="location.href='index.jsp?main=commu/commu_addform.jsp?category=free'">
	...
	<div style="width: 500px; text-align: center;" class="container">
		<ul class="pagination">
			...
			%>
			<li>
				<a href="index.jsp?main=commu/commu_freelist.jsp?category=free&currentPage=<%=startPage - 1%>">이전</a>
			</li>
			<%
			}
			...
			%>
			<li class="active">
				<a href="index.jsp?main=commu/commu_freelist.jsp?category=free&currentPage=<%=pp%>"><%=pp%></a>
			</li>
			<%
			} else {
			%>
			...
			%>
			<li>
				<a href="index.jsp?main=commu/commu_freelist.jsp?category=free&currentPage=<%=endPage + 1%>">다음</a>
			</li>
			<%
			}
			%>

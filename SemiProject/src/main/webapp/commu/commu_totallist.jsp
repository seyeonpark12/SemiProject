...
<body>
	...
	<div class="category" style="width: 1000px; margin-top: 100px; margin-left: 670px;">
		<div style="float: left;">
			<a href="index.jsp?main=commu/commu_totallist.jsp?category=total" style="font-size: 18px; font-weight: bold; color: #653491; padding-right: 10px;">전체 </a>
		</div>
		<div style="float: left;">
	...
	<div style="width: 500px; text-align: center;" class="container">
		<ul class="pagination">
			...
			%>
			<li>
				<a href="index.jsp?main=commu/commu_totallist.jsp?category=total&currentPage=<%=startPage - 1%>">이전</a>
			</li>
			<%
			}
			...
			%>
			<li class="active">
				<a href="index.jsp?main=commu/commu_totallist.jsp?category=total&currentPage=<%=pp%>"><%=pp%></a>
			</li>
			<%
			} else {
			%>
			...
			%>
			<li>
				<a href="index.jsp?main=commu/commu_totallist.jsp?category=total&currentPage=<%=endPage + 1%>">다음</a>
			</li>
			<%
			}
			%>

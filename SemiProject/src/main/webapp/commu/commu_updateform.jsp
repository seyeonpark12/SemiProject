	...
	<div style="margin: 30px 30px;">
		<form action="commu/commu_updateaction.jsp" method="post" enctype="multipart/form-data">
			...
			<div style="text-align: center; padding: 40px;">
				<b class="mv_content" style="display: inline-block; text-align: left; font-size: 20px; font-weight: 600;">게시판 수정 </b>
			</div>
			...
			<table style="width: 1000px;">
				...
				<tr>
					<td colspan="2" style="border: 1px solid lightgray;">
						<img id="showimg" src="<%=dto.getCommu_photo() == null ? "" : "commu_save/" + dto.getCommu_photo()%>" style="max-width: 100%; max-height: 100%; padding: 10px;">
						<textarea name="commu_content" id="commu_content" required="required" style="width: 100%; height: 400px; border: none; outline: none; padding: 10px; overflow: hidden; overflow-wrap: break-word;"><%=dto.getCommu_content()%></textarea>
						<input type="file" name="commu_photo_update" id="commu_photo_update" style="margin-top: 15px; height: 40px; margin-top: 6px;" class="form-control" onchange="readURL(this)">
					</td>

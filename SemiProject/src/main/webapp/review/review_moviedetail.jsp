...
<body>
   <div style="padding: 0; margin-top: 100px;">
      ...
      <table style="width: 1000px; height: 300px;">
         <tr>
            <td rowspan="3" width="30%">
               <!-- 영화이미지 보이는 이미지 -->
               <a style="display: inline-block; width: 100%; height: 400px; margin: 2px; padding: 10px; overflow: hidden;">
                  <img src="movie_save/<%=poster%>" movie_num="<%=movie_num%>" id="movie_poster" class="posterimg">
               </a>
            </td>
      ...
      <div style="width: 1000px; padding: 20px; border: 1px solid lightgray; border-radius: 30px;">
         ...
         <hr>
         <h3 style="padding: 30px; font-size: 18px; font-weight: 700;"><%=compare > 0 ? "기대평" : "리뷰"%><span style="color: #CBB6D9; font-size: 13pt;">
               [<%=totalCount%>]
            </span>
         </h3>

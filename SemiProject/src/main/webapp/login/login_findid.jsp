...
<body>
	<div style="padding: 100px;">
		...
		<form style="float: left; width: 50%; padding: 50px; text-align: center;">
			<h3 align="center" style="font-weight: 600;">아이디찾기</h3>
			<div class="form-group" style="width: 300px; margin-top: 50px;">

				<input type="text" name="user_name" placeholder="이름" class="form-control" required="required" style="width: 300px; margin: 10px 0px; background-color: #fafafa">
		...
		<form style="float: right; width: 50%; padding: 50px; text-align: center;">

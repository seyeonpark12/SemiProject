...
<link href="css/commu.css" type="text/css" rel="stylesheet">
	...
	<div style="margin: 30px 30px; margin-left: 450px;">
		<form action="commu/commu_addaction.jsp" method="post"
			...
			<table style="width: 1000px; margin-left: 0px;">
				<tr>
					<td width="1000"><b class="ca_subject">카테고리(dto값)</b> <b
						class="ca_subject" style="margin-left: 100px;">제목(dto값)</b></td>
				</tr>

				<tr>
					<td width="1000"><b class="ca_subject">작성날짜(dto값)</b> <b
						class="ca_subject" style="margin-left: 100px;">작성자(dto값)</b> <b
						class="ca_subject" style="margin-left: 600px;">조회수(dto값)</b></td>
				</tr>
		...
		<div
			style="width: 1000px; border: 1px solid gray; margin-left: 0px; margin-bottom: 30px; padding: 30px;"
			id="movie_comtent">컨테츠 값 불러오기</div>
